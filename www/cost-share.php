...
<head>
	...
	<title><?php echo $costshareTitle ?></title>
	<meta name="description" content="<?php echo $costshareDescription ?>">
	<meta name="keywords" content="<?php echo $costshareKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentCostShare.html'); ?>
        </div>
