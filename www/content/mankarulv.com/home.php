  ...
  switch ($mankarMain->lang) {
    ...
    case LANGUAGE_FRENCH:
      ?>
        ...
        <a href="<?php echo PICTURES_LOCATION; ?>main_mantra.jpg" rel="lightbox[benefits]" title="Mantra ULV sprayer in evergreens"><img class="pright" src="<?php echo THUMBS_LOCATION; ?>main_mantra.jpg" alt="Mantra ULV Sprayer"></a>
        ...
        <a href="<?php echo PICTURES_LOCATION; ?>main_varimant.jpg" rel="lightbox[benefits]" title="the Varimant ULV Sprayer has a spring-loaded hood"><img class="pleft" src="<?php echo THUMBS_LOCATION; ?>main_varimant.jpg" alt="Varimant ULV Sprayer"></a>
    ...
    default:
      ?>
        ...
        <a href="<?php echo PICTURES_LOCATION; ?>main_mantra.jpg" rel="lightbox[benefits]" title="Mankar-P"><img class="pright" src="<?php echo THUMBS_LOCATION; ?>main_mantra.jpg" alt="Mantra ULV Sprayer"></a>
