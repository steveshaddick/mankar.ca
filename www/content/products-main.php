...
<h3><?=PRODUCTS;?></h3>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="2px" class="tblProduct">
    ...
    <td valign="top" style="background:#f9f8f7; padding-left:5px;"><div  class="highlightLine"><span class="productTitle"><a href="<?php echo $type['pretty_url']; ?>"><?php echo $type['name']; ?></a></span> </div>
                <p>
