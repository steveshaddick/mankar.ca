  ...
  switch ($mankarMain->lang) {
    ...
    default:
      ?>
        ...
        <h2>Efficient rotary atomisers and metering systems for the economical application of form release and other agents</h2>
        <p><strong>ULV technology</strong></p>
        <a href="<?php echo PICTURES_LOCATION; ?>mantisulv1.jpg" rel="lightbox[mantis1]" title="Here is one possible configuration with 4 atomizers mounted above a conveyor."><img class="pright" src="<?php echo THUMBS_LOCATION; ?>mantisulv1.jpg" alt=""></a>
        <p>"ULV" stands for Ultra Low Volume, meaning particularly small output quantities.The ULV metering technology, in conjunction with Mantis rotary atomisers, achieves an ideal narrow droplet spectrum of 35-45 um, ensuring optimum surface wetting.</p>
        <p>With the BL industrial atomiser from Mantis, it is possible to generate approx. 30 million droplets from 1 ml of liquid (900 million droplets from one ounce). The rotary atomiser works without pressure, and the spray pattern is created by means of centrifugal force and using a specially developed atomiser disc. The droplets are deposited evenly on the surface of the mold by means of the vertical air stream generated by the rotation disc and gravity.</p>
        <a href="<?php echo PICTURES_LOCATION; ?>bema1000.jpg" rel="lightbox[mantis1]" title="The BEMA-1000 is a handheld option for smaller operations and maximum flexibility."><img class="pleft" src="<?php echo THUMBS_LOCATION; ?>bema1000.jpg" alt=""></a>  
        <p>Due to these technical advancements, and the precision metering control, you can greatly reduce the amount of release needed to coat your forms.  You can reduce eliminate dripping and streaking due to the large droplets that come out of a pressurized system.</p>
        <br><br><br><br>
      <?php
      break;
  }
