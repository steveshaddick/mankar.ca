...
<head>
	...
	<title><?php echo $benefitsTitle ?></title>
	<meta name="description" content="<?php echo $benefitsDescription ?>">
	<meta name="keywords" content="<?php echo $benefitsKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentBenefits.html'); ?>
        </div>
