...
<head>
	...
	<title><?php echo $rofaTitle ?></title>
	<meta name="description" content="<?php echo $rofaDescription ?>">
	<meta name="keywords" content="<?php echo $rofaKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentRofa.html'); ?>
        </div>
