...
<head>
	...
	<title><?php echo $usersupportTitle ?></title>
	<meta name="description" content="<?php echo $usersupportDescription ?>">
	<meta name="keywords" content="<?php echo $usersupportKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentUserSupport.php'); ?>
        </div>
