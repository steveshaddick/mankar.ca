...
<head>
	...
	<title><?php echo $carryTitle ?></title>
	<meta name="description" content="<?php echo $carryDescription ?>">
	<meta name="keywords" content="<?php echo $carryKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentCarry.html'); ?>
        </div>
