...
<head>
	...
	<title><?php echo $technologyTitle ?></title>
	<meta name="description" content="<?php echo $technologyDescription ?>">
	<meta name="keywords" content="<?php echo $technologyKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentTechnology.html'); ?>
        </div>
