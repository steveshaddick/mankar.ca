...
<head>
	...
	<title><?php echo $contactusTitle ?></title>
	<meta name="description" content="<?php echo $contactusDescription ?>">
	<meta name="keywords" content="<?php echo $contactusKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentContactUs.html'); ?>
        </div>
