...
<head>
	...
	<title><?php echo $driveTitle ?></title>
	<meta name="description" content="<?php echo $driveDescription ?>">
	<meta name="keywords" content="<?php echo $driveKeywords ?>">
...
<div id="container">
  ...
  <div class="colmid">
    <div class="colleft">
      <div class="col1wrap">
        <div class="col1">
         <?php require('includes/'.$lang.'/contentDrive.html'); ?>
        </div>
